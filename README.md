...
#Publish
Push to `main`- the included GitHub Actions workflow(`.github/workflow/deploy.yml`) builds the site and publishes it to GitHub Pages automatically.
# Structure
```
...
2. Add a matching line to the `nav:`section of `mkdocs.yml`-THis is what make it appear in the sidebar on every page
